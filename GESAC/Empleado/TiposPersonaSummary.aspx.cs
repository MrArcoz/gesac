...
{
    public partial class TiposPersonaSummary : System.Web.UI.Page
    {
        readonly TiposPersonaRepository tipo = new TiposPersonaRepository();
        IEnumerable<TiposPersona> lista_tipos;
        ...
        protected void GridView_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Empleado/TiposPersonaDetail.aspx");
        }
