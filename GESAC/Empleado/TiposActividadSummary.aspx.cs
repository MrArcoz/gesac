...
{
    public partial class TiposActividadSummary : System.Web.UI.Page
    {
        readonly TiposActividadRepository tipo = new TiposActividadRepository();
        IEnumerable<TiposActividad> lista_tipos;
        ...
        protected void GridView_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Empleado/TiposActividadDetail.aspx");
        }
