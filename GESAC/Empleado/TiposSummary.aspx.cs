...
{
    public partial class TiposSummary : System.Web.UI.Page
    {
        readonly TiposRepository tipo = new TiposRepository();
        IEnumerable<Tipos> lista_tipos;
        ...
        protected void GridView_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                int id = int.Parse(e.Values["IdTipo"].ToString());
        ...
        protected void GridView_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Empleado/TiposDetail.aspx");
        }
