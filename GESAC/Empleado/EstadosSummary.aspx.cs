...
{
    public partial class EstadosSummary : System.Web.UI.Page
    {
        readonly EstadosRepository estados = new EstadosRepository();
        IEnumerable<Estados> lista_edos;
        ...
        protected void GridView_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Empleado/EstadosDetail.aspx");
        }
        ...
        protected void GridView_DataBound(object sender, EventArgs e)
        {
            for (int i = 0; i < lista_edos.Count(); i++)
            {
                ...
                lb.Text = lista_edos.ElementAt(i).Estatus == true ? "Desactivar" : String.Format("{0}{1}", "Activar", "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
            }
        }
