    ...
    <asp:FormView ID="FormView1" runat="server" CellPadding="4" 
        ...
        <EditItemTemplate>
            <table style="width:551px">
                <tr>
                    ...
                    <td colspan="3"><asp:Label ID="IdActividadLabel" runat="server" Text='<%# Eval("IdActividad") %>' /></td>
                </tr>
                <tr>
                    <td class="style4">Expediente</td>
                    <td colspan="3"><asp:DropDownList ID="IdExpedienteDropDownList" runat="server" 
                ...
                <tr>
                    ...
                    <td colspan="3" class="style6"><asp:DropDownList ID="IdUsuarioDropDownList" runat="server" 
                ...
                <tr>
                    ...
                    <td colspan="3"><asp:DropDownList ID="IdEstatusDropDownList" runat="server" 
                ...
                <tr>
                    ...
                    <td colspan="3"><asp:TextBox ID="DescripcionTextBox" runat="server" 
                            Text='<%# Bind("Descripcion") %>' Height="225px" Width="385px" 
                            TextMode="MultiLine" /></td>
                </tr>
                <tr>
                    <td class="style4">Observaciones</td>
                    <td colspan="3"><asp:TextBox ID="ObservacionesTextBox" runat="server" 
                            Text='<%# Bind("Observaciones") %>' Height="225px" Width="385px" 
                            TextMode="MultiLine" /></td>
                </tr>
                <tr>
                    <td class="style4">Fecha Acuerdo</td>
                    <td colspan="3"><asp:TextBox ID="FechaAcuerdoTextBox" runat="server" 
                ...
                <tr>
                    ...
                    <td colspan="3"><asp:TextBox ID="FechaPublicacionTextBox" runat="server" 
                ...
                <tr>
                    ...
                    <td colspan="3"><asp:DropDownList ID="IdTipoDropDownList" runat="server" 
                ...
                <tr>
                    ...
                    <td colspan="3" style="height:50px; vertical-align:top"><asp:TextBox ID="AvanceTextBox" runat="server" Text='<%# Bind("Avance") %>' />
                ...
                <tr>
                    ...
                    <td colspan="3"><asp:DropDownList ID="IdProyectoDropDownList" runat="server" 
                            SelectedValue='<%# Bind("IdProyecto") %>' DataSourceID="SqlDSProyectos" 
                            DataTextField="Proyecto" DataValueField="IdProyecto" >
                        </asp:DropDownList></td>
                </tr>
                <tr>
                    <td colspan="4"><asp:LinkButton ID="UpdateButton" runat="server" CausesValidation="True" CommandName="Update" Text="Actualizar" />&nbsp;
        ...
        <InsertItemTemplate>
            <table style="width:551px">
                ...
                <tr>
                    ...
                    <td colspan="3"><asp:DropDownList ID="IdUsuarioDropDownList" runat="server" 
                ...
                <tr>
                    <td class="style4">Fecha Acuerdo</td>
                    <td colspan="3"><asp:TextBox ID="FechaAcuerdoTextBox1" runat="server" 
                            Text='<%# Bind("FechaAcuerdo") %>' />
                ...
                <tr>
                    <td colspan="4"><asp:LinkButton ID="InsertButton" runat="server" CausesValidation="True" 
        ...
        <ItemTemplate>
            <table style="width:551px">
                ...
                <tr>
                    <td class="style4">Descripción</td>
                    <td colspan="3"><asp:Label ID="DescripcionLabel" runat="server" 
                            Text='<%# Bind("Descripcion") %>' CssClass="justify" /></td>
                </tr>
                <tr>
                    <td class="style4">Observaciones</td>
                    <td colspan="3"><asp:Label ID="ObservacionesLabel" runat="server" 
                            Text='<%# Bind("Observaciones") %>' CssClass="justify" /></td>
                </tr>
                <tr>
                    <td class="style4">Fecha Captura</td>
                    <td colspan="3"><asp:Label ID="FechaCapturaLabel" runat="server" Text='<%# Bind("FechaCaptura") %>' /></td>
                </tr>
                <tr>
                    <td class="style4">Fecha Acuerdo</td>
                    <td colspan="3"><asp:Label ID="FechaAcuerdoLabel" runat="server" Text='<%# Bind("FechaAcuerdo") %>' /></td>
                </tr>
                <tr>
                    <td class="style4">Fecha Publicación</td>
                    <td colspan="3"><asp:Label ID="FechaPublicacionLabel" runat="server" Text='<%# Bind("FechaPublicacion") %>' /></td>
                </tr>
                <tr>
                    <td class="style4">Tipo Actividad</td>
                    <td colspan="3"><asp:DropDownList ID="IdTipoDropDownList" runat="server" 
                ...
                <tr>
                    ...
                    <td colspan="3" height="0"><asp:DropDownList ID="IdUserCapturaDropDownList" runat="server" 
                            DataSourceID="SqlDSUsuarios" DataTextField="Comment" DataValueField="UserId" 
                ...
                <tr>
                    <td class="style4">Avance</td>
                    <td colspan="3"><asp:Label ID="AvanceLabel" runat="server" Text='<%# Bind("Avance") %>' /></td>
                </tr>
                <tr>
                    <td class="style4">Proyecto</td>
                    <td colspan="3"><asp:DropDownList ID="IdProyectoDropDownList" runat="server" 
                ...
                <tr>
                    <td colspan="4"><asp:LinkButton ID="EditButton" runat="server" CausesValidation="False" CommandName="Edit" Text="Editar" />&nbsp;
