...
{
    public partial class ActividadesCSummary : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["actividades"] == null)
                Session["actividades"] = actividad.consulta(Convert.ToInt16(Session["Id"]));
        ...
        protected void GridView_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Cliente/ActividadesCDetail.aspx");
        }
